...
class UNetwork(nn.Module):
    def __init__(self) -> None:
        ...
        self.deconv1 = nn.ConvTranspose2d(
            128, 64, kernel_size=2, stride=2, padding=0, bias=False
        )
        self.deconv2 = nn.ConvTranspose2d(
            128, 32, kernel_size=2, stride=2, padding=0, bias=False
        )
        self.deconv3 = nn.ConvTranspose2d(
            64, 16, kernel_size=2, stride=2, padding=0, bias=False
        )
        self.deconv4 = nn.ConvTranspose2d(
            32, 1, kernel_size=2, stride=2, padding=0, bias=False
        )
