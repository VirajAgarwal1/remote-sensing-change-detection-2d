"""
Source:https://github.com/GeoZcx/A-deeply-supervised-image-fusion-network-for-change-detection-in-remote-sensing-images/blob/master/pytorch%20version/DSIFN.py
"""
import torch
...
class DSIFN(nn.Module):
    def __init__(self, num_band=3, num_class=10, pretrained_path=None, **kwargs):
        super().__init__()
        self.base = vgg16_base(pretrained_path)
    ...
    def forward(self, x):
        ...
        return [branch_5_out, branch_1_out, branch_2_out, branch_3_out, branch_4_out]
